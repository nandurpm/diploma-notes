...
async function initializeDiscussion() {
  ...
  // PERFORMANCE OPTIMIZATION: Cache the Intl.DateTimeFormat instance in module-level scope
  // to avoid redundant object creation when formatting lists of comments on render passes.
