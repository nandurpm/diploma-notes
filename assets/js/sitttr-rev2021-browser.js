...
(() => {
  ...
  // BUG FIX: previously ignored `s` entirely and always returned the generic
  // REV2021 scheme index page, so "Open Syllabus" never opened a specific
  // course. Course codes are reused across revisions on the SITTTR site, so
  // &scheme=REV2021 disambiguates which curriculum this code belongs to.
  function syllabus(s) { return `https://www.sitttrkerala.ac.in/index.php?r=site%2Fdiploma-syllabus-course-contents&course=${encodeURIComponent(s.code)}&scheme=REV2021`; }
