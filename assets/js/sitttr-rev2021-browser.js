...
(() => {
  ...
  // REVERTED: appending &scheme=REV2021 does not scope the "course" param —
  // it's ignored by the government site, so this was opening whichever 2026
  // course happens to share the same numeric code as the 2021 subject. No
  // verified per-course REV2021 page exists, so the scheme index is the only
  // link that's guaranteed to show correct (if less specific) content.
