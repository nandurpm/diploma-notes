(() => {
  ...
  const LESSON_CODES = new Set(["1001","1002","1003","1004","1005","1006","1007","1008","2001","2002","2003","2031","2032","2038","2039","2041","2049","3023","3031","3032","3041","3042","3043","3044","3045","3046","3047","3048","3049","3132","4001","4022","4031","4041","4042","4043","5031","5041","5042","5043","5043A","6001","6002","6007","6009","6041","6041A","6041B","6041C","6042A","6042B","6042C","6042D","6061A","6061B","6061C","6062A","6062B","6067","6068","6069"]);
  ...
  function makeDownloadLink(href, verified) {
    ...
    if (verified) {
      ...
      link.title = "Generated PDF is not available yet. This opens the lesson in print/PDF mode.";
    }
    return link;
  }
  ...
  function applyOfficialSubjectCorrections(subjects) {
    ...
    MANUAL_SUBJECTS.forEach((subject) => {
  ...
  async function loadSubjects() {
    ...
    subjectsPromise = fetch(`${rootPrefix()}assets/js/subjects.js?v=20260630-4022-fluid1`)
      .then((response) => {
      ...
      .catch((error) => {
        ...
        return applyOfficialSubjectCorrections([]);
      });
    ...
    return `
      <article class="subject-card reveal" data-subject-code="${esc(normalizeCode(subject.code))}" data-notes-href="${esc(notesHref)}" data-lesson-href="${esc(lessonHref)}" data-lesson-available="${lessonAvailable ? "true" : "false"}">
        ...
        <div class="action-row">
          ...
          ${lessonAvailable ? unavailable("Preparing notes…", "notes-status") : unavailable("Notes unavailable", "notes-status")}
  ...
  async function validateNotesForGrid(grid) {
    ...
    cards.forEach(async (card) => {
      ...
      if (ok) {
        ...
        row.insertBefore(Object.assign(document.createElement("span"), { className: "availability-label notes-status", textContent: "Notes unavailable" }), qp || null);
      }
      status?.remove();
    });
  }
