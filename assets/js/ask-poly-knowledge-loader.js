(() => {
  ...
  const KNOWLEDGE_VERSION = "20260716-whole-site-v1";
  ...
  function subjectScore(query, subject) {
    ...
    if (/lesson|notes|download|resource/.test(normalize(query))) {
      if (subject.lessonAvailable || subject.notesAvailable) total += 5;
    }
    return total;
  }
