/* Purpose: Mock exam loader - Descriptive comment added for clarity */
(() => {
  "use strict";
  ...
  function applyPaperText(M) {
    ...
    set("heroTitle", M.heroTitle);
    set("heroSubtitle", M.heroSubtitle);
    set("resultTitle", M.resultTitle || `${M.displayName} · ${M.subjectCode}`);
    set("historyHeading", M.historyTitle || `Your recent ${M.subjectCode} attempts`);
  }

  Promise.resolve()
    .then(() => loadScript("/assets/js/mock-exam-papers.js"))
    .then(() => {
