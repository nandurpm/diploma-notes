...
(() => {
  ...
  const websiteAnswers = [
    ...
    [/official.*syllabus|syllabus.*link|sample.*question|question.*paper/, "Open a subject card and choose **Download Syllabus** or **Download Model Question Paper** when available. Those buttons use the POLY PMNA PDF archive."],
    ...
    [/note.*(missing|unavailable|not)|download.*note/, "The subject card shows an unavailable state when the matching archive PDF is missing. Use the available Download Syllabus or Download Model Question Paper control."],
