...
PAGE_METADATA: dict[str, tuple[str, str, str]] = {
    "index.html": (
        "Kerala Polytechnic Diploma Notes & Study Materials | Diploma Notes",
        "Kerala Polytechnic diploma notes, Revision 2021 syllabus, lesson pages, study materials and question papers for students.",
        "Home",
    ),
    "about.html": (
        "About the Kerala Polytechnic Study Hub | Diploma Notes",
        "Learn how to use Diploma Notes, access Kerala Polytechnic study resources and find official SITTTR Kerala references.",
        "About",
    ),
    "contact.html": (
        "Help, Corrections & Content Requests | Diploma Notes",
        "Request missing Kerala Polytechnic study content, report broken links and submit corrections to Diploma Notes.",
        "Help",
    ),
    "departments.html": (
        "Kerala Polytechnic Departments | Diploma Notes",
    ...
    "disclaimer.html": (
        ...
        "Read the educational-content, accuracy, external-link and official-source disclaimer for the Diploma Notes study portal.",
        "Disclaimer",
    ),
    "lessons.html": (
        "Kerala Polytechnic Lesson Pages | Diploma Notes",
        "Browse Kerala Polytechnic lesson pages by revision, department, semester, subject title and subject code.",
        "Lessons",
    ),
    "materials-2015.html": (
        "Kerala Polytechnic 2015 Scheme Materials | Diploma Notes",
    ...
    "model-question-papers.html": (
        "Kerala Polytechnic Model Question Papers | Diploma Notes",
    ...
    "previous-question-papers.html": (
        "Kerala Polytechnic Previous Question Papers | Diploma Notes",
        "Find Kerala Polytechnic previous examination question papers and subject-wise exam preparation resources.",
        "Previous Question Papers",
    ),
    "privacy.html": (
        "Privacy Policy | Diploma Notes",
        "Read how Diploma Notes handles website usage, comments, third-party services and privacy-related information.",
        "Privacy",
    ),
    "revision-2021.html": (
        "Revision 2021 Diploma Departments | Kerala Polytechnic Study Hub",
    ...
    "terms.html": (
        ...
        "Read the terms for using Diploma Notes educational resources, external links, comments and downloadable content.",
        "Terms",
    ),
}
...
def department_metadata(local: str, text: str) -> tuple[str, str, str]:
    ...
    title = f"{name} Revision 2021 Subjects | Kerala Polytechnic Study Hub"
    description = (
...
def page_metadata(local: str, text: str) -> tuple[str, str, str]:
    ...
    title = f"{name} | Diploma Notes"
    description = f"Kerala Polytechnic {name} resources and student information from Diploma Notes."
    return title, description, name
