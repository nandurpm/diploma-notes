...
def head(title: str, description: str, canonical: str, json_ld: str, *, directory: bool = False) -> str:
    page_styles = (
...
def build_department_page(programme: dict[str, object], rows: list[dict[str, object]]) -> str:
    ...
    json_ld = json.dumps({
        ...
        "@type": "CollectionPage",
        "name": title,
        "url": f"{SITE}/revision-2026/{slug}.html",
        "description": description,
        "isPartOf": {"@type": "WebSite", "name": "POLY PMNA", "url": SITE + "/"},
        "publisher": {"@type": "Organization", "name": "POLY PMNA", "url": SITE + "/"},
        "inLanguage": ["en", "ml"],
