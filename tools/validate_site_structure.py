...
def main() -> int:
    ...
    check("lesson files are in the validation set", len(rev21_lessons) == 91 and len(rev26_lessons) in (35, 36, 42, 44, 46), lesson_count_detail)
    check("lesson files are in the validation set", len(rev21_lessons) == 91 and len(rev26_lessons) in (44, 46), lesson_count_detail)
    check(
